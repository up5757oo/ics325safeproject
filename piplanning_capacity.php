...
<!--HTML Drop Downs with temp dummy data (For Visual Purposes only)-->
...
<head><h1> BEAR Capacity Calculator -UNDER CONSTRUCTION-
</h1>
<br>
</head>
...
<label
for="ART">Agile Release Train (ART) - temp data:
<select
name="art"
value="art"
required>
                ...
                <option
value="one">ART_one</option>

                <option
value="two">ART_two</option>

                <option
value="three">ART_three</option>

                <option
value="four">ART_four</option>
...
<label
for="AT">Agile Train (AT) - temp data:
<select
name="at"
value="at"
required>
                ...
                <option
value="one">AT_one</option>

                <option
value="two">AT_two</option>

                <option
value="three">AT_three</option>

                <option
value="four">AT_four</option>
...
<label
for="PI">Program Increment (PI) - temp data:
<select
name="pi"
value="pi"
required>
                ...
                <option
value="one">PI_one</option>

                <option
value="two">PI_two</option>

                <option
value="three">PI_three</option>

                <option
value="four">PI_four</option>
...
$pi_id_file = 
file_get_contents("dataFiles/pi_id_cache.json");

$pi_id_json = 
json_decode($pi_id_file, 
true);
...
$pi_id_select_results = 
mysqli_query($db, 
$pi_id_now_query);

if ($pi_id_select_results->num_rows >
0) {

while($pi_id_now =
$pi_id_select_results->fetch_assoc()) {
...
$pi_id_menu = 
$pi_id_menu.'<option value="'.$pi_id_item.'" selected>'.$pi_id_item.'</option>';

} else{

$pi_id_menu = 
$pi_id_menu.'<option value="'.$pi_id_item.'">'.$pi_id_item.'</option>';

}

};

$pi_id_array=array($pi_id."-1",
$pi_id."-2" ,$pi_id."-3" ,$pi_id."-4",
$pi_id."-5",$pi_id."-6",$pi_id."-IP");

?>

<!--

form for submitting PI with current date that will be prepopulated
...
<h3 style=" color: #01B0F1; font-weight: bold;">Bear's Capacity Calculations for the Agile Team</h3>
...
<td id='capacity-table-td' style='font-weight:500; text-align: center; background: #e9e9e9;'><input id='story' class='capacity-text-input' type='text' name='storypoints[]' value='".$storypts."' readonly='readonly' style='border:
 0; background: #e9e9e9;' />&nbsp;pts</td>
